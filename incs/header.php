<div class="tcnb">
	<div class="tcart" style="margin-top:-50px;margin-right: 20px; text-align: right;width: 100%;">
		<a href="cart"><i class="fa fa-shopping-cart" style="color: #000;"> cart</i>&nbsp;<span class="cartcount"></span></a>
	</div>	
</div>
<div class="navbar cnb">
	<a href="home" class="brand-name"><img src="imgs/logo.png" width="180"></a>
	<ul class="tsrch2 mt-3">
		<form method="post" action="index.php?page=search">
			<input type="text" name="search" placeholder="search" required>
			<button name="srchmit"><i class="fa fa-search"></i></button>
		</form>
	</ul>
